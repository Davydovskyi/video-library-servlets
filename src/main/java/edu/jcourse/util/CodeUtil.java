...
public class CodeUtil {
    public static final String INVALID_GENDER_CODE = "error.invalid.gender";
    public static final String INVALID_ROLE_CODE = "error.invalid.role";
    public static final String INVALID_EMAIL_CODE = "error.invalid.email";
    public static final String EXIST_EMAIL_CODE = "error.exist.email";
