...
public class MessageUtil {
    public static final String GENDER_INVALID_MESSAGE = "Gender is invalid";
    public static final String ROLE_INVALID_MESSAGE = "Role is invalid";
    ...
    public static final String PASSWORD_INVALID_MESSAGE = "Password is invalid";
    ...
    public static final String RELEASE_YEAR_INVALID_MESSAGE = "Release year is invalid";
    public static final String COUNTRY_INVALID_MESSAGE = "Country is invalid";
    public static final String GENRE_INVALID_MESSAGE = "Genre is invalid";
